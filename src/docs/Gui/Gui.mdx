...
An alternative user interface based on React and currently under development is available [here][openhospital-ui].

## How to build

To build this project you'll need Java JDK 8+ and Maven. Additionally, you'll need to build and install locally the [Core component][openhospital-core] component of Open Hospital. Once you do that, to build this project just type:
...
You need a MySQL database running locally (e.g. the Docker container available in the Core project),
