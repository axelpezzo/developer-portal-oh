  ...
  return (
    <Container>
      <Link
        {...props}
        to={to}
        sx={{...styles.link, my: 0, padding: '.4rem 1.5rem', fontFamily: `'Montserrat', sans-serif`, fontWeight: '400'}}
      ...
      {showHeadings &&
        headings.map((heading) => (
          <Link
            key={heading.slug}
            to={`${to}#${heading.slug}`}
            sx={{...styles.smallLink, my: 0, padding: '.4rem 1.5rem', fontFamily: `'Montserrat', sans-serif`, fontWeight: '400' }}
